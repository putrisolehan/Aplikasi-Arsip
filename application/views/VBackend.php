...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="temp/index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Arsip</b>Digital</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="<?php echo site_url('Welcome/DataWNI'); ?>"><i class="fa fa-book"></i> <span>Data WNI</span></a></li>
        <li><a href="<?php echo site_url('Welcome/DataWNA'); ?>"><i class="fa fa-book"></i> <span>Data WNA</span></a></li>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Selalu teliti dalam memasukkan data</h3>
